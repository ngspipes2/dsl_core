package pt.isel.ngspipes.dsl_core.descriptors.pipeline.jackson_entities.wrapper;

import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jackson_entities.wrapper.output.WrapperOutputDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jackson_entities.wrapper.parameter.WrapperParameterDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jackson_entities.wrapper.repository.WrapperPipelineRepositoryDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jackson_entities.wrapper.repository.WrapperToolRepositoryDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jackson_entities.wrapper.step.WrapperStepDescriptor;
