package pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.spread;

import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.spread.strategyDescriptor.WrapperOneToManyStrategyDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.spread.strategyDescriptor.WrapperOneToOneStrategyDescriptor;
