package pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step;
...
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.exec.WrapperCommandExecDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.exec.WrapperPipelineExecDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.input.WrapperChainInputDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.input.WrapperParameterInputDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.input.WrapperSimpleInputDescriptor;
import pt.isel.ngspipes.dsl_core.descriptors.pipeline.jacksonEntities.wrapper.step.spread.WrapperSpreadDescriptor;
